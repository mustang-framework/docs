---
description: >-
  Profiling is a crucial aspect of optimizing your application's performance and
  gaining a deeper insight into the request handling process. It can
  significantly expedite the debugging process.
---

# Profiler

Mustang incorporates the third-party package [Laravel Debugbar](https://github.com/barryvdh/laravel-debugbar) to gather profiling data.

By default, this package presents the profiling data directly in the browser. Nevertheless, Mustang employs the `Mustang\Core\Middlewares\Http\ProfilerMiddleware` to include the profiling data in the response.
    ...
    "_profiler": {
        ...
        "logs": {
            ...
            "messages": [
                ...
                {
                    "message": "[2017-09-18 17:38:15] testing.INFO: New User registration. ID = 970ylqvaogmxnbdr | Email = mustang@mail.test.      Thank you for signing up.\n</div>\n</body>\n</html>\n  \n",
                    "message_html": null,
                    "is_string": false,
                    "label": "info",
